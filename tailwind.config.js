  ...
  theme: {
    ...
    extend: {
      colors: {
        ...
        input: "var(--color-input)", /* deep-maroon */
        ring: "var(--color-ring)", /* matte-gold */
        background: "var(--color-background)", /* deep-maroon */
        foreground: "var(--color-foreground)", /* white */
        primary: {
          DEFAULT: "var(--color-primary)", /* deep-maroon */
        ...
        muted: {
          DEFAULT: "var(--color-muted)", /* deep-maroon */
          foreground: "var(--color-muted-foreground)", /* white */
        },
        accent: {
          DEFAULT: "var(--color-accent)", /* matte-gold */
          foreground: "var(--color-accent-foreground)", /* dark-charcoal */
        },
        popover: {
          DEFAULT: "var(--color-popover)", /* deep-maroon */
          foreground: "var(--color-popover-foreground)", /* white */
        },
        card: {
          DEFAULT: "var(--color-card)", /* deep-maroon */
